...
void clearAllClock(){
	HAL_GPIO_WritePin(GPIOA, PA1_Pin |PA2_Pin|PA3_Pin|PA4_Pin|PA5_Pin|
			PA6_Pin|PA7_Pin|PA8_Pin|PA9_Pin|PA10_Pin|PA11_Pin|PA12_Pin,SET);
}
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  setNumberOnClock(minutes/300);
	  setNumberOnClock(hours/3600);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, PA1_Pin|PA2_Pin|PA3_Pin|PA4_Pin
                          ...
                          |PA9_Pin|PA10_Pin|PA11_Pin|PA12_Pin, GPIO_PIN_RESET);
